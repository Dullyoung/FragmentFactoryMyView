...
public class SongTextView extends View {
    ...
    private String mText="文字精确高度文字精 ";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RectF rectF = new RectF(0,0,animatedValue,getMeasuredHeight());
        Log.i("aaaa", "onDraw: "+getMeasuredHeight());
        //然后再画矩形 矩形左上下位置都和bitmap一致  右侧逐渐变化，设置矩形为自己想要的颜色，
        //因为bitmap采用的通道是ARGB_8888，所以只会绘制有东西的部分，就是PNG，如果没有东西，就不会绘制出颜色，达到文字染色的效果
    ...
    int animatedValue;
    public void startUi() {
        animator = ValueAnimator.ofInt(0, 750);//属性动画插值器
